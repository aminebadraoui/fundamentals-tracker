...
const getCryptoData = (crypto, rawData, cotData, technical_data, news_sentiment_data) => {
  const pairData = {
    "pair": "EURUSD",
  ...
  const country1_data = getCountryData(cryptoAssets[crypto].countries[0], rawData)

  pairData.pair = crypto

  pairData.country_1.name = cryptoAssets[crypto].countries[0]
  ...
  pairData.inflationScore = pairData.country_1.inflationScore > 0 ? -100 : pairData.country_1.inflationScore < 0 ? 100 : 0
  pairData.employmentScore = pairData.country_1.employmentScore > 0 ? -100 : pairData.country_1.employmentScore < 0 ? 100 : 0
  pairData.housingScore = pairData.country_1.housingScore > 0 ? -100 : pairData.country_1.housingScore < 0 ? 100 : 0
  pairData.growthScore = pairData.country_1.growthScore > 0 ? -100 : pairData.country_1.growthScore < 0 ? 100 : 0
  pairData.interestRateScore = pairData.country_1.interestRateScore > 0 ? -100 : pairData.country_1.interestRateScore < 0 ? 100 : 0
  ...
  if (news_sentiment_data.news_sentiment[`${cryptoAssets[crypto].apiSymbol}`].length > 0) {
    news_sentiment_data.news_sentiment[`${cryptoAssets[crypto].apiSymbol}`].slice(0,7).map((news) => {
